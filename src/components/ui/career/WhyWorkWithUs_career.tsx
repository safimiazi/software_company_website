  ...
  return (
    <div>
      <WhyWorkWithUs
        ...
        sectionDescription="At Easy Soft Bangladesh, we believe in fostering a workplace where innovation meets collaboration. Our team thrives in an environment that encourages growth, values creativity, and celebrates achievements. Discover a culture built on trust, excellence, and shared success."
        benefits={benefits}
      />
    </div>
  );
